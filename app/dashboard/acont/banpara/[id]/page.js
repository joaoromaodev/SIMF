...
export default async function BanparaContaDetailPage({ params }) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <Link href="/dashboard/acont/banpara" className="inline-flex items-center gap-1.5 text-[11px] font-bold text-slate-400 hover:text-para-blue uppercase tracking-widest mb-5 transition-colors">
          <ChevronLeft size={13} />
          Banpará
        </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm font-medium mt-0.5">
                Banpará · Ag. {conta.agencia} · {conta.numero_conta}
