...
export function normalizeRow(reportType, header, values, context, headerResolution) {
  ...
  if (reportType === REPORT_TYPES.NE_DL) {
    return {
      ...
      codigo_plano_interno: toText(getCanonicalValue(rawRow, headerResolution, "codigo_plano_interno")),
  ...
  if (reportType === REPORT_TYPES.DL_OB) {
    return {
      ...
      dl_documento_credor: toText(getCanonicalValue(rawRow, headerResolution, "dl_documento_credor")),
      dl_nome_credor: toText(getCanonicalValue(rawRow, headerResolution, "dl_nome_credor")),
