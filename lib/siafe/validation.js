...
export function ensureStaticScopeCanImport(_existingActiveBatch, _yearScope) {
  // Todos os year_scopes permitem reimport — o batch anterior é substituído
  // atomicamente pela função finalize_siafe_active_import no banco.
}
